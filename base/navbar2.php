<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            ...
            <a class="navbar-brand me-2" href="#">
                <i class="fas fa-user-shield me-2"></i>Editor
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" href="usuario"><i class="fas fa-home me-1"></i> Inicio</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="espacio_editor"><i class="fas fa-map-marker-alt me-1"></i> Espacio Libre</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="cambio_pass_editor"><i class="fas fa-key me-1"></i> Cambiar contraseña</a>
                    </li>
                </ul>
