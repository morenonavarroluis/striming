<!-- Modal -->
<div class="modal fade" id="Modaleditor<?php echo $fetch['video_id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="config/editor_video.php" method="post">
